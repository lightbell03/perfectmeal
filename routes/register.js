    ...
    try{
        ...
        try {
            ...
            if(registRows.length === 0){
                ...
                await con.query("CREATE TABLE " + userEmail + "_nutrian_db (division VARCHAR(10) NOT NULL, date DATE NOT NULL, \
                        ...
                        chole_Qy FLOAT NOT NULL, nacl_Qy FLOAT NOT NULL, ref_Qy FLOAT NOT NULL)");
